...
public abstract class FirebaseListAdapter<T> extends BaseAdapter {
     ...
     */
    FirebaseListAdapter(Query ref, Class<T> modelClass, int layout, Activity activity) {
        this.ref = ref;
        ...
        listener = this.ref.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String previousChildName) {
                ...
                if (FirebaseListAdapter.this.modelClass == ChatPicture.class) {
                    ((ChatPicture)model).setKey(dataSnapshot.getKey());
                }
